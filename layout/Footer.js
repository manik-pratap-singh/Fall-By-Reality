          ...
          <div className="col-xl-3 col-sm-6">
            ...
            >
              ...
              <div className="info-item">
                ...
                <div className="content">
                  Need Any Help? <br />
                  Call : <a href="callto:+91 01204232140">+91 01204232140</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="copyright-text">
                <p>
                  Copyright © 2025 <Link href="/">Fallbyreality</Link>, All Rights
                  Reserved.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <ul>
                ...
                <li>
                  ...
                  <a href="callto:01204232140">01204232140
          ...
          <div className="row">
            ...
            <div className="col-md-9 text-center text-lg-end">
              <div className="copyright-text text-center text-md-end">
                <p>
                  Copyright © <Link href="/">Fallbyreality</Link>, all rights
                  reserved.
                </p>
              </div>
            </div>
      ...
      <div className="footer-cta-wrap">
        <div className="container">
          ...
          >
            ...
            <div className="Phone no. wow fadeInRight delay-0-2s">
        ...
        <div className="row medium-gap">
          <div className="col-xl-3 col-sm-6">
            <div className="footer-widget widget_about wow fadeInUp delay-0-2s">
              ...
              <p>
                We deliver smart IT solutions that help your business grow faster, 
                stay secure, and stand out in the digital world
              </p>
            ...
            <div className="footer-widget widget_newsletter wow fadeInUp delay-0-6s">
              ...
              <form action="#">
                ...
                <input
                  id="email"
                  type="email"
                  placeholder="support@fallbyreality.com"
                  required
                />
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-4">
              <div className="copyright-text text-lg-end wow fadeInLeft delay-0-2s">
                <p>© 2025 Fallbyreality. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
