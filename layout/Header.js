              ...
              <div className="top-right text-center text-lg-end">
                <ul>
                  <li>
                    ...
                    <a href="mailto:Support@fallbyreality.com">
                      Support@fallbyreality.com
                    </a>
                  </li>
                  <li>
          ...
          <div className="header-inner before-after-none rel d-flex align-items-center">
            <div className="logo-outer">
              <div className="logo">
                <Link href="/">
                  <img
                    src="\assets\images\logos\logo-two.png.png"
                    alt="Logo"
                    title="Logo"
                  />
                </Link>
            ...
            <div className="nav-outer ms-lg-auto me-lg-auto clearfix">
              ...
              <nav className="main-menu navbar-expand-lg">
                <Menu
                  ...
                  logo="\assets\images\logos\logo-two.png.png"
                />
              </nav>
              {/* Main Menu End*/}
            </div>
              ...
              <div className="col-xl-3 col-lg-6">
                <div className="top-left text-center text-md-start">
                  <ul>
                    ...
                    <li>
                      <a href="mailto:support@fallbyreality.com">
                        support@fallbyreality.com <i className="fal fa-arrow-right" />
                      </a>
                    </li>
                  </ul>
                </div>
...
const Menu = ({ logo = "\assets\images\logos\logo-two.png", singleMenu }) => {
  return (
    <Accordion>
