                    ...
                    <div className="row gap-50 align-items-center">
                      ...
                      <div className="col-xl-4 col-lg-5">
                        <div className="content">
                          <p>
                            From web to mobile, we craft custom software that drives innovation, boosts efficiency, and scales with your vision
                          </p>
                  ...
                  <div className="accordion-body">
                    <div className="row gap-50 align-items-center">
                      ...
                      <div className="col-xl-4 col-lg-5">
                        <div className="content">
                          <p>
                            Seamlessly move to the cloud with secure, scalable, and cost-effective infrastructure—designed for agility and business growth
                          </p>
                          <Link className="read-more" href="service-details">
                            Read More <i className="far fa-arrow-right" />
                          </Link>
                  ...
                  <div className="accordion-body">
                    <div className="row gap-50 align-items-center">
                      ...
                      <div className="col-xl-4 col-lg-5">
                        <div className="content">
                          <p>
                            Get expert guidance to align technology with business goals. We help plan, optimize, and future-proof your IT investments
                  ...
                  <div className="accordion-body">
                    <div className="row gap-50 align-items-center">
                      ...
                      <div className="col-xl-4 col-lg-5">
                        <div className="content">
                          <p>
                            Safeguard your data, systems, and networks with end-to-end cybersecurity solutions tailored to today’s threats
                          </p>
                          <Link className="read-more" href="service-details">
                            Read More <i className="far fa-arrow-right" />
                          </Link>
                  ...
                  <div className="accordion-body">
                    <div className="row gap-50 align-items-center">
                      ...
                      <div className="col-xl-4 col-lg-5">
                        <div className="content">
                          <p>
                           Unlock the power of your data with real-time insights, smart dashboards, and strategic analytics for better decisions
                          </p>
                          <Link className="read-more" href="service-details">
                            Read More <i className="far fa-arrow-right" />
                          </Link>
